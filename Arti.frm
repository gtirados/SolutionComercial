...
Begin VB.Form frmARTI 
   ...
   Begin VB.CommandButton cmd_AddItem 
      Caption         =   "Actualizar Precios y Artículos"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
...
Public Sub BLOQUEA_TEXT(Optional o1, Optional o2, Optional o3, Optional o4, Optional o5, Optional o6, Optional o7, Optional o8, Optional o9, Optional o10, Optional o11)
...
End If
End Sub
Public Sub DESBLOQUEA_TEXT(Optional o1, Optional o2, Optional o3, Optional o4, Optional o5, Optional o6, Optional o7, Optional o8, Optional o9, Optional o10, Optional o11)
'** BLOQUEA TEXTBOX  CANTIDAD DE OBJECTOS **
If Not IsMissing(o1) Then
 o1.Enabled = True
End If
...
'End If
   ...
   'Modifique para que muestre con cualquier usuario
    If Trim(LK_CODUSU) = "ADMIN" And LK_CODCIA = "01" Then
...
'lblStockprov.Caption = Trim(Nulo_Valor0(artloc_llave!ART_STOCK_PROV))
...
WCALIDAD = 1 'Val(Right(CmbCalidad.Text, 3))
...
'If LK_EMP = "HER" Then
 ...
 'artloc_llave!ART_STOCK_PROV = vStock_Proveedor 'Agregado para stock referencial--JC
'End If
artloc_llave.Update
...
If Left(cmdModificar.Caption, 2) = "&G" Then
    ...
    Do Until pre_mayor.EOF
      ...
      End If
       ...
       pre_mayor!PRE_COSTO = Round(Val((grid_unid.TextMatrix(fila, 3)) / ((100 + LK_IGV) / 100)), 4) 'agregado gts
       
       '=======agregado gts para q actualize el costo promedio en tabla articulo================
       ...
       If Not arm_llave.EOF Then
       arm_llave.Edit
       arm_llave!ARM_COSPRO = Round(Val((grid_unid.TextMatrix(fila, 3)) / ((100 + LK_IGV) / 100)), 4)
       arm_llave.Update
       End If
       End If
       '====================================================================================
...
AGREGA:
    ...
    For fila = VARFILA To grid_unid.rows - 1
       ...
       pre_mayor!PRE_COSTO = Round(Val((grid_unid.TextMatrix(fila, 3)) / ((100 + LK_IGV) / 100)), 4) 'Agregado por JCR 08/01/2010
   ...
   Select Case wsGrid.COL
     Case 5
       If frmARTI.cmddolares.Tag = "D" Then
         wsGrid.TextMatrix(wsGrid.Row, 16) = Format(wsTexto.Text, "0.00")
       Else
         wsGrid.TextMatrix(wsGrid.Row, 21) = Format(wsTexto.Text, "0.00")
       End If
     Case 7
       If frmARTI.cmddolares.Tag = "D" Then
         wsGrid.TextMatrix(wsGrid.Row, 17) = Format(wsTexto.Text, "0.00")
       Else
         wsGrid.TextMatrix(wsGrid.Row, 22) = Format(wsTexto.Text, "0.00")
       End If
     Case 9
       If frmARTI.cmddolares.Tag = "D" Then
         wsGrid.TextMatrix(wsGrid.Row, 18) = Format(wsTexto.Text, "0.00")
       Else
         wsGrid.TextMatrix(wsGrid.Row, 23) = Format(wsTexto.Text, "0.00")
       End If
     Case 11
       If frmARTI.cmddolares.Tag = "D" Then
         wsGrid.TextMatrix(wsGrid.Row, 19) = Format(wsTexto.Text, "0.00")
       Else
         wsGrid.TextMatrix(wsGrid.Row, 24) = Format(wsTexto.Text, "0.00")
       End If
     Case 13
       If frmARTI.cmddolares.Tag = "D" Then
         wsGrid.TextMatrix(wsGrid.Row, 20) = Format(wsTexto.Text, "0.00")
       Else
         wsGrid.TextMatrix(wsGrid.Row, 25) = Format(wsTexto.Text, "0.00")
       End If
    ''*********************************PRECIO6
     Case 30
       If frmARTI.cmddolares.Tag = "D" Then
         wsGrid.TextMatrix(wsGrid.Row, 31) = Format(wsTexto.Text, "0.00")
       Else
         wsGrid.TextMatrix(wsGrid.Row, 32) = Format(wsTexto.Text, "0.00")
       End If
    ''**********************************************
   End Select
  End If
...
grid_unid.TextMatrix(WSROW, WSCOL - 1) = Format(valor, "0.00")
...
grid_unid.TextMatrix(grid_unid.Row, WSCOL + 1) = Format(valor, "0.00")
  Select Case WSCOL
    Case 4
       If frmARTI.cmddolares.Tag = "D" Then
         grid_unid.TextMatrix(grid_unid.Row, 16) = Format(valor, "0.00")
       Else
         grid_unid.TextMatrix(grid_unid.Row, 21) = Format(valor, "0.00")
       End If
    Case 6
       If frmARTI.cmddolares.Tag = "D" Then
         grid_unid.TextMatrix(grid_unid.Row, 17) = Format(valor, "0.00")
       Else
         grid_unid.TextMatrix(grid_unid.Row, 22) = Format(valor, "0.00")
       End If
    Case 8
       If frmARTI.cmddolares.Tag = "D" Then
         grid_unid.TextMatrix(grid_unid.Row, 18) = Format(valor, "0.00")
       Else
         grid_unid.TextMatrix(grid_unid.Row, 23) = Format(valor, "0.00")
       End If
    Case 10
       If frmARTI.cmddolares.Tag = "D" Then
         grid_unid.TextMatrix(grid_unid.Row, 19) = Format(valor, "0.00")
       Else
         grid_unid.TextMatrix(grid_unid.Row, 24) = Format(valor, "0.00")
       End If
    Case 12
       If frmARTI.cmddolares.Tag = "D" Then
         grid_unid.TextMatrix(grid_unid.Row, 20) = Format(valor, "0.00")
       Else
         grid_unid.TextMatrix(grid_unid.Row, 25) = Format(valor, "0.00")
       End If
''*************************************************PRECIO6
    Case 29
       If frmARTI.cmddolares.Tag = "D" Then
         grid_unid.TextMatrix(grid_unid.Row, 31) = Format(valor, "0.00")
       Else
         grid_unid.TextMatrix(grid_unid.Row, 32) = Format(valor, "0.00")
       End If
''*************************************************
End Select
  ...
  If grid_unid.COL = 3 Or grid_unid.COL = 5 Or grid_unid.COL = 7 Or grid_unid.COL = 9 Or grid_unid.COL = 11 Or grid_unid.COL = 13 Or grid_unid.COL = 30 Then ' costo PORCENTAJE
    ...
    'If (grid_unid.Row = 1 And grid_unid.Rows > 2) Then
     ...
     For i = 1 To grid_unid.rows - 1
      'grid_unid.TextMatrix(i, grid_unid.COL) = Format(unitPrice * Val(grid_unid.TextMatrix(i, 1)), "0.0000") quitado para q no calcule automaticamente
      'grid_unid.Row = i
...
If ListView1.Visible = False And KeyCode <> 13 Or Len(txt_alterno.Text) = 1 Then
    ...
    archi = "SELECT ART_KEY, ART_CODCIA, ART_NOMBRE, ART_ALTERNO, ARM_STOCK,PRE_EQUIV,PRE_PRE1, PRE_PRE4, ART_CUENTA_CONTAB_C, ART_CUENTA_CONTAB,PRE_PRE11,PRE_PRE22,ART_FAMILIA,ART_SUBFAM  FROM ARTI, ARTICULO, PRECIOS WHERE (ART_KEY = PRE_CODART) AND (ART_CODCIA = PRE_CODCIA) AND (PRE_FLAG_UNIDAD ='A') AND (ART_CODCIA = ARM_CODCIA) AND (ART_KEY = ARM_CODART) AND ART_KEY <> 0 AND ART_KEY  <> 1 and ART_CODCIA = '" & ws_codcia & "' AND ART_ALTERNO BETWEEN '" & txt_alterno.Text & "' AND  '" & VAR & "' ORDER BY ART_ALTERNO"
...
tempo = tempo + VAR
'tempo = Replace(tempo, "'", "")
archi = "SELECT * FROM ARTI WHERE  ART_KEY <> " & WCODI & " AND ART_KEY  <> 1 and ART_CODCIA = '" & LK_CODCIA & "' AND ART_NOMBRE BETWEEN '" & Replace(WARTI, "'", " ") & "' AND  '" & Replace(tempo, "'", " ") & "' ORDER BY ART_NOMBRE "
ListExiste.Clear
...
Do Until pre_mayor.EOF
   ...
   grid_unid.TextMatrix(fila, 3) = Format((Nulo_Valor0(pre_mayor!PRE_COSTO) * ((100 + LK_IGV) / 100)), "0.00") 'agregado gts
   ...
   If Val(grid_unid.TextMatrix(fila, 3)) <> 0 Then
    ...
    WSPOR = Round((Nulo_Valor0(pre_mayor!PRE_PRE1) * 100) / (Nulo_Valor0(pre_mayor!PRE_COSTO) * ((100 + LK_IGV) / 100)), 0) - 100
   End If
   grid_unid.TextMatrix(fila, 4) = Format(Nulo_Valor0(WSPOR), "0.00")
   If wlista = "S" Then
     grid_unid.TextMatrix(fila, 5) = Round(Format(Nulo_Valor0(pre_mayor!PRE_PRE1), "0.00"), 1)
   Else
     grid_unid.TextMatrix(fila, 5) = Round(Format(Nulo_Valor0(pre_mayor!pre_pre11), "0.00"), 1)
   End If
   grid_unid.TextMatrix(fila, 16) = Format(Nulo_Valor0(pre_mayor!pre_pre11), "0.00")
   grid_unid.TextMatrix(fila, 21) = Format(Nulo_Valor0(pre_mayor!PRE_PRE1), "0.00")
   grid_unid.COL = 6
   grid_unid.CellForeColor = QBColor(9)
   If Val(grid_unid.TextMatrix(fila, 3)) <> 0 Then WSPOR = (Nulo_Valor0(pre_mayor!PRE_PRE2) * 100) / Val(grid_unid.TextMatrix(fila, 3)) - 100
   grid_unid.TextMatrix(fila, 6) = Format(Nulo_Valor0(WSPOR), "0.00")
   If wlista = "S" Then
    grid_unid.TextMatrix(fila, 7) = Format(Nulo_Valor0(pre_mayor!PRE_PRE2), "0.00")
   Else
    grid_unid.TextMatrix(fila, 7) = Format(Nulo_Valor0(pre_mayor!PRE_PRE22), "0.00")
   End If
   grid_unid.TextMatrix(fila, 17) = Format(Nulo_Valor0(pre_mayor!PRE_PRE22), "0.00")
   grid_unid.TextMatrix(fila, 22) = Format(Nulo_Valor0(pre_mayor!PRE_PRE2), "0.00")
   grid_unid.COL = 8
   grid_unid.CellForeColor = QBColor(9)
   If Val(grid_unid.TextMatrix(fila, 3)) <> 0 Then WSPOR = (Nulo_Valor0(pre_mayor!PRE_PRE3) * 100) / Val(grid_unid.TextMatrix(fila, 3)) - 100
   grid_unid.TextMatrix(fila, 8) = Format(Nulo_Valor0(WSPOR), "0.00")
   If wlista = "S" Then
    grid_unid.TextMatrix(fila, 9) = Format(Nulo_Valor0(pre_mayor!PRE_PRE3), "0.00")
   Else
    grid_unid.TextMatrix(fila, 9) = Format(Nulo_Valor0(pre_mayor!PRE_PRE33), "0.00")
   End If
   grid_unid.TextMatrix(fila, 18) = Format(Nulo_Valor0(pre_mayor!PRE_PRE33), "0.00")
   grid_unid.TextMatrix(fila, 23) = Format(Nulo_Valor0(pre_mayor!PRE_PRE3), "0.00")
   grid_unid.COL = 10
   grid_unid.CellForeColor = QBColor(9)
   If Val(grid_unid.TextMatrix(fila, 3)) <> 0 Then WSPOR = (Nulo_Valor0(pre_mayor!PRE_PRE4) * 100) / Val(grid_unid.TextMatrix(fila, 3)) - 100
   grid_unid.TextMatrix(fila, 10) = Format(Nulo_Valor0(WSPOR), "0.00")
   If wlista = "S" Then
     grid_unid.TextMatrix(fila, 11) = Format(Nulo_Valor0(pre_mayor!PRE_PRE4), "0.00")
   Else
     grid_unid.TextMatrix(fila, 11) = Format(Nulo_Valor0(pre_mayor!PRE_PRE44), "0.00")
   End If
   grid_unid.TextMatrix(fila, 19) = Format(Nulo_Valor0(pre_mayor!PRE_PRE44), "0.00")
   grid_unid.TextMatrix(fila, 24) = Format(Nulo_Valor0(pre_mayor!PRE_PRE4), "0.00")
   grid_unid.COL = 12
   grid_unid.CellForeColor = QBColor(9)
   If Val(grid_unid.TextMatrix(fila, 3)) <> 0 Then WSPOR = (Nulo_Valor0(pre_mayor!PRE_PRE5) * 100) / Val(grid_unid.TextMatrix(fila, 3)) - 100
   grid_unid.TextMatrix(fila, 12) = Format(Nulo_Valor0(WSPOR), "0.00")
   If wlista = "S" Then
    grid_unid.TextMatrix(fila, 13) = Format(Nulo_Valor0(pre_mayor!PRE_PRE5), "0.00")
   Else
    grid_unid.TextMatrix(fila, 13) = Format(Nulo_Valor0(pre_mayor!PRE_PRE55), "0.00")
   End If
   grid_unid.TextMatrix(fila, 20) = Format(Nulo_Valor0(pre_mayor!PRE_PRE55), "0.00")
   grid_unid.TextMatrix(fila, 25) = Format(Nulo_Valor0(pre_mayor!PRE_PRE5), "0.00")
''*******************************************************PRECIO6
   grid_unid.COL = 29
   grid_unid.CellForeColor = QBColor(9)
   ...
   grid_unid.TextMatrix(fila, 29) = Format(Nulo_Valor0(WSPOR), "0.00")
   If wlista = "S" Then
    grid_unid.TextMatrix(fila, 30) = Format(Nulo_Valor0(pre_mayor!PRE_PRE6), "0.00")
   Else
    grid_unid.TextMatrix(fila, 30) = Format(Nulo_Valor0(pre_mayor!PRE_PRE66), "0.00")
   End If
   grid_unid.TextMatrix(fila, 31) = Format(Nulo_Valor0(pre_mayor!PRE_PRE66), "0.00")
   grid_unid.TextMatrix(fila, 32) = Format(Nulo_Valor0(pre_mayor!PRE_PRE6), "0.00")
''******************************************************
...
Dim cn_d As New ADODB.Connection
...
RES = MsgBox("!!!! ..... Este proceso Actualiza Precios e Inserta Artículos Nuevos al Sistema. Esta seguro de realizar este proceso.", vbExclamation + vbYesNo, "Import data")
...
If RES = vbNo Then GoTo SALIR
 ...
 cn_s.CursorLocation = adUseClient
 cn_s.Open s_Cnn
's_Cnn = "Provider=MSDASQL;Drive={SQL SERVER};Data Base=BDATOS;pwd=anteromariano;uid=sa"
 s_Cnn = "provider=SQLOLEDB;Data source=laptop;initial catalog=bdatos;password=anteromariano;user id=sa"
 
 cn_d.CursorLocation = adUseClient
 cn_d.Open s_Cnn
 
 s_Sql_DBF = "Select * from LEVANTA"
 rs.Open s_Sql_DBF, cn_s, adOpenForwardOnly, adLockOptimistic, adCmdText
 
 s_Sql = "Select art_alterno from Arti"
 RS_T.Open s_Sql, cn_d, adOpenForwardOnly, adLockOptimistic
 
 pgb_Progress.Visible = True
 pgb_Progress.max = rs.RecordCount + 1
 NumReg = rs.RecordCount
 SIEXISTE = True
 Dim vdonde As Boolean
 While Not rs.EOF
    If IsNull(rs!item) Then GoTo Avanza
   ' If IsNull(rs!DESCRIPCIO) Then GoTo Avanza
    RS_T.MoveFirst
    vdonde = False
    Do While Not RS_T.EOF
        If Trim(rs!item) = Trim(RS_T!art_alterno) Then
            vdonde = True
            Exit Do
        End If
        RS_T.MoveNext
 ...
 ' txt_alterno = Trim(IIf(IsNull(rs!ÍTEM), "", rs!ÍTEM))
  
    'txtMedida.Text = Trim(Nulo_Valors(rs!procedenci))   'es marca
    'txtmarca.Text = Trim(Nulo_Valors(rs!procedenci))     'es color
 '   txtmarca.Text = Trim(Nulo_Valors(rs!PROCEDENCI))     'Marca
    
'  If Trim(RS!subcod) = "" Then
'    txt_alterno = "CALT" + CStr(RS.AbsolutePosition)
'  End If
  
  'txtpor1.Text = Trim(RS!flete)
  ''txt_SerProv = Trim(IIf(IsNull(RS!import), "", RS!import))
  'txt_SerProv2 = Trim(RS!cod_pieza2)
 ' txtnombre = Trim(rs!DESCRIPCIO) ' & "  " & Trim(RS("descri"))  ' & "  " & Trim(RS("pro_proced"))
 ' txtnombre = Replace(txtnombre, "'", " ")
 ' txtMin.Text = Nulo_Valor0(RS("MIN_ART"))
 ' txtMax.Text = Nulo_Valor0(RS("max_art"))
  
'  DS.ListIndex = 1
 ' LK_MONEDA = "2" 'IIf(IsNull(rs!moneda), "S", rs!moneda) ''"D"
'  If (rs!moneda) = 1 Then
 ' DS.Text = "S"
'  Else
'  DS.Text = "D"
'  End If
  ...
  'sCosto = Format(Nulo_Valor0(Trim(RS!sCosto)), "0.00")
  ''sCosto = Format(sCosto * 1.18, "0.000000")
  'grid_unid.TextMatrix(1, 3) = sCosto
  'grid_unid.TextMatrix(1, 27) = sCosto
  
  'PRECIOS SOLES
  'If LK_MONEDA = "1" Then
   ' grid_unid.TextMatrix(1, 22) = Format(Nulo_Valor0(RS!pre_2), "0.00")
    'grid_unid.TextMatrix(1, 23) = Format(Nulo_Valor0(RS!precio_s), "0.00")
    'grid_unid.TextMatrix(1, 24) = Format(Nulo_Valor0(RS!precio_d), "0.00")
    'grid_unid.TextMatrix(1, 25) = Format(Nulo_Valor0(RS!sCosto), "0.000")
    'grid_unid.TextMatrix(1, 16) = 0
    'grid_unid.TextMatrix(1, 17) = 0
  'Else 'PRECIOS DOLARES
  '  grid_unid.TextMatrix(1, 16) = Format(Nulo_Valor0(rs!PRECIO_VEN), "0.00")
    'grid_unid.TextMatrix(1, 17) = Format(Nulo_Valor0(RS!precio_2), "0.0000")
    'grid_unid.TextMatrix(1, 18) = Format(Nulo_Valor0(RS!precio_3), "0.0000")
    'grid_unid.TextMatrix(1, 19) = Format(Nulo_Valor0(RS!precio_4), "0.0000")
    'grid_unid.TextMatrix(1, 20) = Format(Nulo_Valor0(RS!sCosto), "0.000")
    
  'End If
  'grid_unid.TextMatrix(1, 5) = Format(Nulo_Valor0(RS!precio_v), "0.000")
  'grid_unid.TextMatrix(1, 7) = Format(Nulo_Valor0(RS!precio_2), "0.000")
  'grid_unid.TextMatrix(1, 9) = Format(Nulo_Valor0(RS!precio_3), "0.000")
 ' grid_unid.TextMatrix(1, 11) = Format(Nulo_Valor0(RS!precio4), "0.000")
  'grid_unid.TextMatrix(1, 13) = Format(Nulo_Valor0(RS!precio5), "0.000")
  
  ''If Trim(RS(4)) = "UNID" Then
  
  'If Nulo_Valors(rs!UNi_med) = "" Then
  '  grid_unid.TextMatrix(1, 0) = "UNIDAD"
  'Else
   'grid_unid.TextMatrix(1, 0) = Nulo_Valor0(rs!UNi_med)
  'End If
...
'       ' grid_unid.TextMatrix(2, 5) = Format(Nulo_Valor0(RS("scosto")) * equivalencia, "0.00")
'       'PRECIOS SOLES
'        If LK_MONEDA = "1" Then
'            grid_unid.TextMatrix(2, 21) = Format(Nulo_Valor0(RS("pre_1") * equivalencia), "0.00")
'            grid_unid.TextMatrix(2, 22) = Format(Nulo_Valor0(RS("pre_2") * equivalencia), "0.00")
'            grid_unid.TextMatrix(2, 25) = Format(Nulo_Valor0(RS("scosto") * equivalencia), "0.00")
'        Else
'            'PRECIOS DOLARES
...
'        If IsNull(RS("mayo_unid1")) Then
'            GoTo CONTINUAR
'        Else
'            If UCase(Trim(RS("mayo_unid1"))) = UCase(Trim(RS("defe_unid"))) Then GoTo CONTINUAR
'           UNIDAD = Nulo_Valors(RS("mayo_unid1"))
'            equivalencia = RS("dequ_unid1")
'           If equivalencia = 0 Then equivalencia = 1
'        End If
'        grid_unid.Rows = 4
'        grid_unid.TextMatrix(3, 0) = UNIDAD
'        ''grid_unid.TextMatrix(3, 5) = Format(Nulo_Valor0(RS("scosto")) * equivalencia, "0.00")
'     '   'PRECIOS SOLES
'        If LK_MONEDA = "1" Then
'            grid_unid.TextMatrix(3, 21) = Format(Nulo_Valor0(RS("pre_1")) * equivalencia, "0.00")
'            grid_unid.TextMatrix(3, 22) = Format(Nulo_Valor0(RS("pre_2")) * equivalencia, "0.00")
'           grid_unid.TextMatrix(3, 25) = Format(Nulo_Valor0(RS("scosto") * equivalencia), "0.00")
'        Else
'            'PRECIOS DOLARES
'     '       'grid_unid.TextMatrix(2, 16) = Format(Nulo_Valor0(RS("valo_vent") * equivalencia), "0.0000")
'        End If
'        grid_unid.TextMatrix(3, 1) = equivalencia
'
        
    'para la cuarta unidad
'        If IsNull(RS("mayo_unid2")) Then
'            GoTo CONTINUAR
'        Else
'            If UCase(Trim(RS("mayo_unid2"))) = UCase(Trim(RS("defe_unid"))) Then GoTo CONTINUAR
'            UNIDAD = Nulo_Valors(RS("mayo_unid2"))
'            equivalencia = RS("dequ_unid2")
'            If equivalencia = 0 Then equivalencia = 1
'        End If
'        grid_unid.Rows = 5
'        grid_unid.TextMatrix(4, 0) = UNIDAD
'        grid_unid.TextMatrix(4, 5) = Format(Nulo_Valor0(RS("scosto")) * equivalencia, "0.00")
'       'PRECIOS SOLES
'        If LK_MONEDA = "1" Then
'            grid_unid.TextMatrix(4, 21) = Format(Nulo_Valor0(RS("pre_1")) * equivalencia, "0.00")
'            grid_unid.TextMatrix(4, 22) = Format(Nulo_Valor0(RS("pre_2")) * equivalencia, "0.00")
'            grid_unid.TextMatrix(4, 25) = Format(Nulo_Valor0(RS("scosto") * equivalencia), "0.00")
 '       Else
           'PRECIOS DOLARES
           'grid_unid.TextMatrix(2, 16) = Format(Nulo_Valor0(RS("valo_vent") * equivalencia), "0.0000")
 '      End If
 '      grid_unid.TextMatrix(4, 1) = equivalencia
      
   
  ''Else
  '' grid_unid.TextMatrix(1, 0) = "UNID"
  '' grid_unid.TextMatrix(1, 1) = "1"
   ''If Not Trim(RS(4)) = "" Then
   '' grid_UNID_KeyDown 45, 0
   '' grid_unid.TextMatrix(2, 0) = Trim(RS(4))
   '' grid_unid.TextMatrix(2, 1) = "1"
   ''End If
  ''End If
CONTINUAR:
...
'================FAMILIA=======================
      's_Fam = Trim(IIf(IsNull(rs!grupito), "", rs!grupito)) ''DESCRIPCION DE divisiono
      's_Fam = Replace(s_Fam, "'", " ")
      'If s_Fam = "" Then
        'art_familia.ListIndex = 0
      'Else
   '     s_Fam = "HONDA"
   '     FindInCmb art_familia, s_Fam
        'If FindInCmb(art_familia, s_Fam) Then
            'WTMP = Val(Right(art_familia.Text, 12))
'        Else
'            s_Sql = "select max(tab_numtab) as max_n from tablas where tab_codcia='" & LK_CODCIA & "' and tab_tipreg=122"
'            RS_T.Open s_Sql, cn_d, adOpenForwardOnly, adLockOptimistic, adCmdText
'            i_NumTab = IIf(IsNull(RS_T!max_n), 0, RS_T!max_n) + 1
'            WTMP = i_NumTab
'            Set RS_T = Nothing
'            s_Sql = "insert into tablas (tab_codcia,tab_tipreg,tab_numtab,tab_nomlargo)"
'            s_Sql = s_Sql + " VALUES('" & LK_CODCIA & "','122','" & i_NumTab & "','" & s_Fam & "')"
'            cn_d.Execute s_Sql
'            LLENADO_FAM
'            If FindInCmb(art_familia, s_Fam) Then
'                WTMP = Val(Right(art_familia.Text, 12))
...
'        End If
  ...
  '  art_familia_LostFocus
    ...
    '================DIVISION=======================
  '     s_Marca = "REPUESTOS"
  '     FindInCmb art_subfam, s_Marca
'      s_Marca = Nulo_Valors(Trim(rs!subgrupito))  'DESCRIPCION SUBFAMILIA
'      If s_Marca = "" Then
'        s_Marca = "<NINGUNA>"
'      Else
...
'            i_NumTab = IIf(IsNull(RS_T!max_n), 0, RS_T!max_n) + 1
'            Set RS_T = Nothing
'            s_Sql = "insert into tablas (tab_codcia,tab_tipreg,tab_numtab,tab_nomlargo,TAB_CODART)"
'            s_Sql = s_Sql + " VALUES('" & LK_CODCIA & "','123','" & i_NumTab & "','" & Mid(s_Marca, 1, 40) & "'," & Val(WTMP) & ")"
'            cn_d.Execute s_Sql
...
'================MARCA=======================
 ...
 ' s_Marca = Nulo_Valors(Trim(RS!fami))
 ' If s_Marca = "" Then
 '   s_Marca = "OTRA"
 ' Else
 '   s_Marca = Replace(s_Marca, "'", " ")
 ...
 '   Set rs_T = Nothing
 '   s_Sql = "insert into tablas (tab_codcia,tab_tipreg,tab_numtab,tab_nomlargo)"
 '   s_Sql = s_Sql + " VALUES('" & LK_CODCIA & "','131','" & i_NumTab & "','" & s_Marca & "')"
 '   cn_d.Execute s_Sql
 ...
 ' End If
'================================
 ' vStock_Proveedor = Val(Nulo_Valor0(rs!stock))
 ' cmdAgregar = True
  'If F14.Visible = True Then
    'F14.Visible = False
  'End If
  GoTo Avanza
...
ActualizaPrecio:
  If LK_MONEDA = "1" Then
   ' grid_unid.TextMatrix(1, 21) = Format(Nulo_Valor0(rs!PRECIO), "0.00")
   grid_unid.TextMatrix(1, 25) = Format(Nulo_Valor0(rs!costo), "0.00")
    'If Val(rs!Equiv) <> 1 Then
    'grid_unid.TextMatrix(2, 21) = Format(Nulo_Valor0(rs!PRECIOcaja), "0.00")
    'grid_unid.TextMatrix(2, 25) = Format(Nulo_Valor0(rs!costocaja), "0.00")
    'End If
    'vStock_Proveedor = Val(Nulo_Valor0(rs!stock))
    cmdModificar = True
    'If F14.Visible = True Then
...
Avanza:
 ...
 lblprogress.Caption = ""
 SIEXISTE = False
 MsgBox "Proceso terminado satisfactoriamente", vbInformation, "Importar Artículo"
...
Dim RSOrigen As New ADODB.Recordset
     ...
     s_Sql_DBF = "select * from LEVANTA"
     RSOrigen.Open s_Sql_DBF, cn_s, adOpenForwardOnly, adLockOptimistic, adCmdText
    ...
    Do While Not RSOrigen.EOF
        ...
        If Nulo_Valor0(RSOrigen("STOCK")) = 0 Then GoTo Ava
        wcanti_unid = Val(RSOrigen("STOCK"))
        SQ_OPER = 3
        ...
        arm_llave!ARM_STOCK = wcanti_unid + (arm_llave!ARM_STOCK)
        arm_llave!ARM_INGRESOS = wcanti_unid + (arm_llave!ARM_INGRESOS)
        arm_llave!ARM_Saldo_n = wcanti_unid + (arm_llave!ARM_Saldo_n)
        ...
        If WS_NUMSEC = 20 Then
            ...
            WS_NUMSEC = 0
        End If
        If RSOrigen("Moneda") = "1" Then
            PRECIO = 0 ' Val(RSORIGEN("scosto") / 1.19)
        Else
         '   PRECIO = 0
        End If
        PRECIO = Format(PRECIO, "0.000")
        ...
        far_llave!FAR_equiv = 1 'RSOrigen("Equivalencia")
        far_llave!far_descri = RSOrigen("uni_med")
        far_llave!far_PESO = 0
        far_llave!far_signo_car = 0
        far_llave!far_signo_car = 0
        far_llave!far_signo_arm = 1
        ...
        far_llave!far_turno = 0
        far_llave!far_concepto = " "
        far_llave!far_concepto = "Ajuste de Inventario"
        far_llave!far_codusu = LK_CODUSU
        far_llave!FAR_HORA = Format(Now, "hh:mm:ss AMPM")
        far_llave!FAR_NUM_LOTE = 0
        far_llave!FAR_PEDSER = 0
...
LlenarAllog:
        ...
        all_llave!ALL_autocon = "Ajuste de Inventario"
        all_llave!all_chenum = 0
        all_llave!ALL_CHESEC = 0
        all_llave!ALL_NUMSER = 1
        ...
        all_llave!ALL_TIPO_CAMBIO = 3.55
        all_llave!ALL_flete = 0
        all_llave!ALL_SUBTRA = "Aumento de Inventario"
        all_llave!ALL_HORA = Time
        all_llave!all_FACART = ""
        all_llave!all_concepto = "Ajuste de Inventario"
        all_llave!ALL_numoper2 = 1
...
On Error GoTo Handler
    ...
    Do While Not RDRPRECIOS.EOF
       ...
       ' grdarticulos.TextMatrix(fila, 6) = Trim(Nulo_Valor0(RDRPRECIOS!ART_STOCK_PROV))
...
Private Sub SETGRID()
    grdarticulos.Clear
    grdarticulos.FormatString = "|Codigo|Descripcion|Unidad|Stock||Stock Proveedor"
    grdarticulos.rows = 2
    grdarticulos.Cols = 7
    ...
    grdarticulos.ColWidth(6) = 1000 '|STOCK PROVEE
End Sub
...
Dim aux_f As String
    ...
    For i = 0 To cbo.ListCount - 1
     ...
     If UCase(Trim(aux_f)) = UCase(Trim(s_Familia)) Then
      cbo.ListIndex = i
      aux = True
      Exit For
     End If
